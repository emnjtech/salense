...
export enum AuditAction {
  ...
  ShopifyConnectionCreated = "SHOPIFY_CONNECTION_CREATED",
  ShopifyConnectionValidationFailed = "SHOPIFY_CONNECTION_VALIDATION_FAILED",
  ShopifyConnectionValidationSucceeded = "SHOPIFY_CONNECTION_VALIDATION_SUCCEEDED",
